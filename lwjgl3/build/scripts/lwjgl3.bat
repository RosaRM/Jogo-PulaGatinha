...
set CLASSPATH=%APP_HOME%\lib\BouncingGirl-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" interno.jogo.Jumpman.lwjgl3.Lwjgl3Launcher %*
